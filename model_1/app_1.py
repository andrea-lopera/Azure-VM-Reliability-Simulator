...
model = joblib.load('model_1/model.pkl')
ctv = CoxTimeVaryingFitter()
ctv = joblib.load('model_1/survival_model_1.pkl')
try:
    explainer = joblib.load('model_1/shap_explainer_1.joblib')
except:
    with open('model_1/shap_explainer_1.pkl', 'rb') as f:
        explainer = pickle.load(f) 
df = pd.read_csv('model_1/vm_telemetry_1.csv')
failure_history = np.load('model_1/failure_history_1.npy', allow_pickle=True).item()
with open('model_1/feature_names_1.txt', 'r') as f:
